...
public class MillionFlaxBlueWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MillionFlaxBlueWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MillionFlaxBlueWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MillionFlaxBlueWLAIW/InitOutcome.xml").getDocumentElement();
